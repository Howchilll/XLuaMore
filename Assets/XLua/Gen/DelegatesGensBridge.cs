...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp2(string p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp4(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<string, double>))
			{
			    return new System.Action<string, double>(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(System.Func<int, int, int>))
			{
			    return new System.Func<int, int, int>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(System.Func<string, string>))
			{
			    return new System.Func<string, string>(__Gen_Delegate_Imp4);
			}
